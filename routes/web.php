...
Route::prefix('vendor')->name('vendor.')->group(function () {
    ...
    Route::middleware('auth:vendor')->group(function () {
        // Dashboard
        Route::get('/dashboard', \App\Livewire\Vendor\Dashboard\VendorDashboard::class)->name('dashboard');

        // Vendors
        Route::prefix('vendors')->name('vendors.')->group(function () {
            Route::get('/', \App\Livewire\Vendor\Vendors\Index::class)->name('index');
            Route::get('/{business}', \App\Livewire\Vendor\Vendors\Detail::class)->name('detail');
        });
