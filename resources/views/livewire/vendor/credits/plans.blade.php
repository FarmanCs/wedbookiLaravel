<div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
                @foreach ($plans as $plan)
                    @php
                        ...
                        $annualPrice = $plan->yearly_price;

                        $quarterlyDiscount = 5;
                        $annualDiscount = 10;
                        $finalMonthly = $monthlyPrice;
                        $finalQuarterly = ($quarterlyPrice * (100 - $quarterlyDiscount)) / 100;
                        $finalAnnual = ($annualPrice * (100 - $annualDiscount)) / 100;
                    @endphp
                        ...
                        <div class="p-6 flex-1">
                            ...
                            <div class="mb-6">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    ...
                                    <span
                                        x-text="cycle === 'monthly' ? 'Monthly' : (cycle === 'quarterly' ? 'Quarterly' : 'Annual') + ' billing'"></span>
                                </p>
                            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-zinc-700">
                            @php
                                $allFeatures = $plans->flatMap->features->unique('id');
                            @endphp
                    ...
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <button wire:click="buyCreditPlan({{ $plan->id }})"
                                class="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-semibold shadow-md transition-all flex items-center justify-center gap-2 group/btn">
                                <flux:icon.shopping-cart class="w-5 h-5" />
                                Buy {{ $plan->name }}
                            </button>
                        </div>
    ...
    <!-- Confirmation Modal for Subscription Plan -->
    ...
    <!-- Confirmation Modal for Ad Credits -->
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        @php
                            $finalPrice = $selectedCreditPlan->price;
                            if ($selectedCreditPlan->discounted_percentage) {
                                $finalPrice =
                                    ($selectedCreditPlan->price * (100 - $selectedCreditPlan->discounted_percentage)) /
                                    100;
                            }
                        @endphp
                        <p class="text-gray-700 dark:text-gray-300">Total: <strong
                    ...
                    <div class="mt-6 flex justify-end gap-3">
                        <button wire:click="cancelCreditConfirm"
                            class="px-4 py-2 rounded-xl bg-gray-200 dark:bg-zinc-700 text-gray-900 dark:text-white hover:bg-gray-300 dark:hover:bg-zinc-600 transition">Cancel</button>
                        <button wire:click="confirmCreditPurchase"
                            class="px-6 py-2 rounded-xl bg-gradient-to-r from-amber-600 to-orange-600 text-white font-semibold shadow-md hover:shadow-lg transition">Confirm</button>
                    </div>
                </div>
            </div>
        </div>
